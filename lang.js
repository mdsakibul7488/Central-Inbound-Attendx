const LANG = {
  en: {
    ...
    'hint-eid':'Format: C/S/M + space + 4-6 digits (e.g. C 00123, S 0012)',
    ...
    'pin-title':'Enter PIN','pin-sub':'Verify your identity',
    'btn-verify-pin':'Confirm','btn-cancel-pin':'Cancel',
    ...
    'lbl-distance':'Distance from office',
    ...
    'err-eid-format':'Format: C, S, or M + space + 4 to 6 digits (e.g. C 00123)',
    ...
    'msg-signup-ok':'Account created! Waiting for admin approval.',
  ...
  bn: {
    ...
    'hint-eid':'ফরম্যাট: C/S/M + স্পেস + ৪-৬ সংখ্যা (যেমন C 00123)',
    ...
    'pin-title':'পিন দিন','pin-sub':'পরিচয় নিশ্চিত করুন',
    'btn-verify-pin':'নিশ্চিত করুন','btn-cancel-pin':'বাতিল',
    ...
    'msg-signup-ok':'অ্যাকাউন্ট তৈরি হয়েছে! অ্যাডমিনের অনুমোদনের জন্য অপেক্ষা করুন।',
